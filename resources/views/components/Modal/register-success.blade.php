<div
  class="hidden modal overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
    ...
    <div class="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <div class="p-5 rounded-t-xl text-center mt-5 mx-10">
        <svg class="m-auto mb-5" width="160" height="160" viewBox="0 0 160 160" fill="none"
          ...
          <path d="M113.335 55L67.502 100.833L46.6687 80" stroke="#22B07D" stroke-width="10" stroke-linecap="round"
      ...
      <form action="index.php" method="GET">
        ...
        <div class="px-6 pb-6 rounded-b-xl mx-10">
          ...
          <a href="explore.php?auth"
            class="block text-center bg-serv-button text-white text-lg py-3 px-12 my-2 rounded-lg w-full" type="submit">
            Find Services
          </a>
