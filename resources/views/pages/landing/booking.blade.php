...
<section class="w-auto flex min-h-[85vh] pt-6 pb-20 mx-auto lg:mx-12 px-4">
  <div class="m-auto text-center h-auto">
    ...
    <p class="leading-8 text-serv-text mb-6"> To continue payment, please contact directly <br
        class="lg:block hidden">our Freelancer through WhatsApp</p>

    <a href="http://wa.me/628123456789"
      class="bg-serv-button text-white text-md font-medium py-4 w-80 my-2 rounded-2xl text-center inline-block">Continue
      to Chat</a>
