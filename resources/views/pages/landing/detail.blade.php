              ...
              <div class="flex items-center col-span-12 p-2 lg:col-span-6">
                <div class="flex items-center space-x-4">
                  ...
                  <img class="w-20 h-20 object-cover rounded-full"
                    ...
                    loading="lazy">
                  @else
                  <svg class="w-20 h-20 object-cover rounded-full text-gray-300" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path
      ...
      <div class="mb-4 border rounded-lg border-serv-testimonial-border">
        ...
        <div class="flex items-start px-4 pt-6">
          ...
          <img class="object-cover w-16 h-16 mr-4 rounded-full"
            src="{{ url(Storage::url($service->user->detail_user->photo)) }}" alt="photo profile" loading="lazy">
          @else
        ...
        <div class="flex items-center px-2 py-3 mx-4 mt-4 border rounded-full border-serv-testimonial-border">
          ...
          <div class="flex-1 text-sm font-medium text-center">
            <svg class="inline" width="24" height="24" viewBox="0 0 24 24" fill="none"
              ...
              <path d="M19 13C19 15 19 18.5 14.6552 18.5C9.63448 18.5 6.12644 18.5 5 18.5" stroke="#082431"
                stroke-width="1.5" stroke-linecap="round" />
              <path d="M4 11.5C4 9.5 4 6 8.34483 6C13.3655 6 16.8736 6 18 6" stroke="#082431" stroke-width="1.5"
                stroke-linecap="round" />
              <path d="M7 21.5L4.14142 18.6414C4.06332 18.5633 4.06332 18.4367 4.14142 18.3586L7 15.5" stroke="#082431"
                stroke-width="1.5" stroke-linecap="round" />
