              ...
              <div class="px-4 py-5 sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6">
                    ...
                    <input placeholder="Jelaskan Service apa yang kamu tawarkan?" type="text" name="description"
                  ...
                  <div class="col-span-6">
                    <label for="advantage-service" class="block mb-2 font-medium text-gray-700 text-md">Keunggulan
                      Service kamu</label>
                    ...
                    <input placeholder="Keunggulan Service" type="text"
                      name="{{ ('advantage-services['.$advantage_item->id.']') }}" id="advantage-services"
                      autocomplete="advantage-services"
                      class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                  ...
                  <div class="col-span-6 -mb-6">
                    <label for="estimation & revision" class="block mb-3 font-medium text-gray-700 text-md">Estimasi
                      Service & Jumlah Revisi</label>
                  </div>
                  ...
                  <div class="col-span-6">
                    ...
                    <div class="grid grid-cols lg:grid-cols-3 md:grid-cols-2 gap-4">
                      ...
                      <div class="mb-2">
                        <img src="{{ url(Storage::url($thumbnail_item->thumbnail)) }}" alt="thumbnail"
                          class="inline object-cover w-20 h-20 rounded" for="choose">

                        <input placeholder="Thumbnail" type="file" name="{{ 'thumbnails['.$thumbnail_item->id.']' }}"
                  ...
                  <div class="col-span-6">
                    <label for="advantage-users" class="block mb-3 font-medium text-gray-700 text-md">Keunggulan
                      kamu</label>

                    @forelse ($advantage_user as $advantage_user_item)
                    <input placeholder="Keunggulan Kamu" type="text"
                      name="{{ ('advantage-users['.$advantage_user_item->id.']') }}" id="advantage-users"
                      autocomplete="advantage-users"
                      class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                  ...
                  <div class="col-span-6">
                    <label for="taglines" class="block mb-3 font-medium text-gray-700 text-md">Tagline <span
                        class="text-gray-400">(Optional)</span></label>
