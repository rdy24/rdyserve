      ...
      <div class="col-span-4 text-right">
        <div @click.away="open = false" class="relative z-10 hidden mt-5 lg:block" x-data="{ open: false }">
          <button
            ...
            <img class="inline w-12 h-12 mr-3 rounded-full" src={{ url("https://randomuser.me/api/portraits/men/1.jpg")
              }} alt="">
            Halo, Miles
          </button>
        </div>
    ...
    <div class="grid gap-5 md:grid-cols-12">
            ...
            <tbody class="bg-white">
              <tr class="text-gray-700">
                  ...
                  <div class="flex items-center text-sm">
                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                      <img class="object-cover w-full h-full rounded-full" src={{
                        url("https://randomuser.me/api/portraits/men/2.jpg") }} alt="" loading="lazy" />
                ...
                <td class="w-2/4 px-1 py-5">
                  <div class="flex items-center text-sm">
                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                      <img class="object-cover w-full h-full rounded" src={{
                        url("https://randomuser.me/api/portraits/men/3.jpg") }} alt="" loading="lazy" />
                      <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true">
                      </div>
                    </div>
                    <div>
              ...
              <tr class="text-gray-700">
                <td class="w-1/3 px-1 py-5">
                  <div class="flex items-center text-sm">
                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                      <img class="object-cover w-full h-full rounded-full" src={{
                        url("https://randomuser.me/api/portraits/men/4.jpg") }} alt="" loading="lazy" />
                      <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true">
                      </div>
                    </div>
                    <div>
                ...
                <td class="w-2/4 px-1 py-5">
                  <div class="flex items-center text-sm">
                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                      <img class="object-cover w-full h-full rounded" src={{
                        url("https://randomuser.me/api/portraits/men/5.jpg") }} alt="" loading="lazy" />
                      <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true">
                      </div>
                    </div>
                    <div>
              ...
              <tr class="text-gray-700">
                <td class="w-1/3 px-1 py-5">
                  <div class="flex items-center text-sm">
                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                      <img class="object-cover w-full h-full rounded-full" src={{
                        url("https://randomuser.me/api/portraits/men/6.jpg") }} alt="" loading="lazy" />
                      <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true">
                      </div>
                    </div>
                    <div>
                ...
                <td class="w-2/4 px-1 py-5">
                  <div class="flex items-center text-sm">
                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                      <img class="object-cover w-full h-full rounded" src={{
                        url("https://randomuser.me/api/portraits/men/7.jpg") }} alt="" loading="lazy" />
                      <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true">
                      </div>
                    </div>
                    <div>
      ...
      <aside class="p-4 lg:col-span-5 md:col-span-12 md:pt-0">
        <div class="relative w-full h-56 m-auto text-white transition-transform transform bg-red-100 rounded-xl">
          ...
          <img class="relative object-cover w-full h-full rounded-xl" src={{ asset("/assets/images/card-background.png")
            }} alt="">
