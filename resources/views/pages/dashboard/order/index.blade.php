              ...
              <tr class="text-gray-700 border-b">
                  ...
                  <div class="flex items-center text-sm">
                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                      ...
                      <img class="object-cover w-full h-full rounded-full"
                        src="{{ url(Storage::url($order->user_buyer->detail_user->photo)) }}" alt="photo freelancer"
                        loading="lazy" />
                      @else
                      <svg class="object-cover w-full h-full rounded text-gray-300" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path
                ...
                <td class="px-1 py-5 text-sm">
                  ...
                  <a href="{{ route('member.order.show', $order->id) }}"
                    class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">Details</a>
                  ...
                  <a href="{{ route('member.order.edit', $order->id) }}"
                    class="px-4 py-2 mt-2 text-center text-white rounded-xl bg-serv-email">Submit</a>
